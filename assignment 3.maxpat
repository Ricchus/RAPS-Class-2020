...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.0, 247.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 806.0, 442.0, 187.0, 116.0 ],
					"varname" : "bp.Chorus",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1379.0, 269.0, 157.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 798.0, 10.0, 726.0, 232.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 806.0, 303.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 806.0, 586.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 228.0, 676.0, 279.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.0, 671.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 70.0, 812.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 306.0, 406.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.0, 541.0, 304.0, 116.0 ],
					"varname" : "bp.LPF",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 70.0, 402.0, 201.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 70.0, 10.0, 726.0, 232.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 70.0, 247.0, 314.0, 116.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-10::obj-1" : [ "Mix[1]", "Mix", 0 ],
			"obj-10::obj-21" : [ "HPF[1]", "HPF", 0 ],
			"obj-10::obj-25" : [ "LPF[1]", "LPF", 0 ],
			"obj-10::obj-28" : [ "Feedback[1]", "Feedback", 0 ],
			"obj-10::obj-7" : [ "bypass[1]", "bypass", 0 ],
			"obj-10::obj-9" : [ "time[1]", "Time", 0 ],
			"obj-12::obj-22" : [ "Mute[4]", "Mute", 0 ],
			"obj-12::obj-52" : [ "Level[1]", "Level", 0 ],
			"obj-12::obj-55" : [ "DSP[1]", "DSP", 0 ],
			"obj-12::obj-56" : [ "OutputChannel[1]", "OutputChannel", 0 ],
			...
			"obj-23::obj-120" : [ "Max pulse[2]", "Max pulse", 0 ],
			"obj-23::obj-125" : [ "NoteGrid[2]", "NoteGrid", 0 ],
			"obj-23::obj-130" : [ "mute[2]", "mute", 0 ],
			"obj-23::obj-155" : [ "Swing amount[1]", "Swing amount", 0 ],
			"obj-23::obj-157" : [ "Swing enable[1]", "Swing enable", 0 ],
			"obj-23::obj-185" : [ "Sequence[1]", "Sequence", 0 ],
			"obj-23::obj-2" : [ "trans_trig[1]", "trans_trig", 0 ],
			"obj-23::obj-22" : [ "Pattern[1]", "Pattern", 0 ],
			"obj-23::obj-25" : [ "GateTime[1]", "GateTime", 0 ],
			"obj-23::obj-28" : [ "Sync[1]", "Sync", 0 ],
			"obj-23::obj-4" : [ "live.text[1]", "live.text", 0 ],
			"obj-23::obj-89" : [ "Reset[3]", "Reset", 0 ],
			"obj-23::obj-95" : [ "Steps[6]", "Steps", 0 ],
			"obj-23::obj-96" : [ "Pulse[1]", "Pulse", 0 ],
			"obj-24::obj-1" : [ "Sync[2]", "Sync", 0 ],
			"obj-24::obj-129" : [ "Tempo", "Tempo", 0 ],
			"obj-24::obj-30" : [ "sync_source", "sync_source", 0 ],
			"obj-24::obj-76" : [ "Transport", "Transport", 0 ],
			"obj-25::obj-1" : [ "Depth", "Depth", 0 ],
			"obj-25::obj-2" : [ "Rate", "Rate", 0 ],
			"obj-25::obj-23" : [ "bypass[2]", "bypass", 0 ],
			"obj-25::obj-28" : [ "Center", "Center", 0 ],
			"obj-25::obj-3" : [ "Regen[1]", "Regen", 0 ],
			"obj-26::obj-106" : [ "CV3[3]", "CV3", 0 ],
			"obj-26::obj-107" : [ "Linear[2]", "Linear", 0 ],
			"obj-26::obj-11" : [ "PWM[2]", "PWM", 0 ],
			"obj-26::obj-129" : [ "CV2[3]", "CV2", 0 ],
			"obj-26::obj-36" : [ "PW[2]", "PW", 0 ],
			"obj-26::obj-4" : [ "Waveform[2]", "Waveform", 0 ],
			"obj-26::obj-45" : [ "FreqMode[2]", "FreqMode", 0 ],
			"obj-26::obj-46" : [ "Offset[7]", "Offset", 0 ],
			"obj-26::obj-51" : [ "Freq[3]", "Freq", 0 ],
			"obj-26::obj-53" : [ "Mute[6]", "Mute", 0 ],
			...
			"snapshot" : 			{
				"valuedictionary" : 				{
					"parameter_values" : 					{
						...
						"DSP" : 1.0,
						"DSP[1]" : 1.0,
						"Depth" : 13150.558820077860219,
						"Feedback[1]" : -72.0,
						"Freq" : 8160.588872730889307,
						"FreqMode" : 1.0,
						"FreqMode[1]" : 1.0,
						"FreqMode[2]" : 1.0,
						"Freq[1]" : 6766.246564310111353,
						"Freq[2]" : 6763.827789816807126,
						"Freq[3]" : 11051.522744459931346,
						"Frequency" : 77.952755905511864,
						"GateTime" : 80.0,
						"GateTime[1]" : 80.0,
						"LPF[1]" : 20000.0,
						"Level" : -16.208167293121384,
						"Level[1]" : -23.265365332045761,
						"Linear" : 0.0,
						"Linear[1]" : 0.0,
						"Linear[2]" : 0.0,
						"Mix[1]" : 50.0,
						...
						"Mute[5]" : 0.0,
						"Mute[6]" : 0.0,
						"Offset" : 12.999999999999972,
						"Offset[1]" : 0.0,
						"Offset[2]" : 0.0,
						"Offset[7]" : 33.999999999999957,
						"OutputChannel" : 0.0,
						"OutputChannel[1]" : 0.0,
						"PW" : 64.960629921259823,
						"PWM" : 11.023622047244096,
						"PWM[1]" : 26.77165354330706,
						"PWM[2]" : 34.645669291338557,
						"PW[1]" : 50.0,
						"PW[2]" : 72.047244094488164,
						"Pattern" : 1.0,
						"Pattern[1]" : 1.0,
						"Quadrants" : 1.0,
						"Rate" : 8.183466041890203,
						"Regen[1]" : 0.389763779527559,
						"Res" : 0.0,
						"ResCV" : 0.0,
						"Response" : 1.0,
						"Steps" : 8.0,
...
,
						"fileref" : 						{
							...
							"filepos" : -1,
							"snapshotfileid" : "0b8a6073ebfcfe188b5f5e441eb4e40d"
						}
